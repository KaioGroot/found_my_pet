    ...
    return (
        <div className="flex flex-col p-8 pb-20 gap-40 sm:p-20 font-[family-name:var(--font-geist-sans)]">
            <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start mt-20">
                ...
                <h2 className="text-md sm:text-4xl font-semibold">Find and share your lost pets with fellow pet lovers.</h2>
                        ...
                        data.map((pet) => (
                            <div key={pet.id} className="card">
                                ...
                                <div className="p-4  backdrop-blur-md  ">
                                    <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-br backdrop-blur-md   from-purple-500 to-red-800">
                                        {pet.name}
                                    </h3>
                                    <p>{pet.comment}</p>
                                </div>
