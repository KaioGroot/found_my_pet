  ...
  return (
    <div className="container flex w-full mx-auto px-4 py-24 rounded-full backdrop-blur-3xl mt-20 font-[family-name:var(--font-geist-sans)] bg-purple-50">
      <div className="md:flex-col flex justify-between md:w-1/2 rounded backdrop-blur-3xl px-4 py-4 bg-purple-200 md:overflow-y-auto md:border-r md:border-gray-200">
        ...
        <div className="mt-4">
          <p className="font-bold">Pets cadastrados: <span className="text-purple-600">{perdidos.length}</span></p>
        </div>
      </div>
      ...
      <div className="md:w-1/2 px-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col">
            <label htmlFor="photo" className="font-bold mb-2">Foto do Pet</label>
            <input
              type="file"
              id="photo"
              accept="image/*"
          ...
          <div className="flex flex-col">
            <label htmlFor="name" className="font-bold mb-2">Nome do Pet</label>
            <input
              type="text"
              id="name"
              value={pet.name}
          ...
          <div className="flex flex-col">
            <label htmlFor="breed" className="font-bold mb-2">Raça</label>
            <input
              type="text"
              id="breed"
              value={pet.breed}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col">
              <label htmlFor="age" className="font-bold mb-2">Idade</label>
              <input
                type="number"
                id="age"
                value={pet.age}
            ...
            <div className="flex flex-col">
              <label htmlFor="weight" className="font-bold mb-2">Peso (kg)</label>
              <input
                type="number"
                id="weight"
                value={pet.weight}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col">
              <label htmlFor="city" className="font-bold mb-2">Cidade</label>
              <input
                type="text"
                id="city"
            ...
            <div className="flex flex-col">
              <label htmlFor="state" className="font-bold mb-2">Estado</label>
              <input
                type="text"
                id="state"
          ...
          <div className="flex flex-col">
            <label htmlFor="category" className="font-bold mb-2">Categoria</label>
            <select
              id="category"
              value={pet.category}
          ...
          <div className="flex flex-col">
            <label htmlFor="description" className="font-bold mb-2">Descrição</label>
            <textarea
              id="description"
